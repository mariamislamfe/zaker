      ...
      <div className="bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-700 overflow-hidden shadow-sm">
        <div className="px-5 py-4 border-b border-zinc-100 dark:border-zinc-700">
          <h3 className="text-sm font-bold text-zinc-800 dark:text-zinc-100 flex items-center gap-2">
            <Brain size={16} className="text-violet-500" /> تحليل سلوك المذاكرة
          </h3>
          <p className="text-xs text-zinc-400 mt-0.5">يحلل أنماط مذاكرتك خلال آخر 30 يوم</p>
        </div>
        <div className="p-8 flex flex-col items-center gap-4 text-center">
          ...
          <div>
            <p className="text-sm font-semibold text-zinc-700 dark:text-zinc-200">اكتشف أنماط مذاكرتك</p>
            <p className="text-xs text-zinc-400 mt-1">أحسن يوم، أضعف يوم، تأثير النوم، وأكتر</p>
          </div>
          <button
            onClick={fetch}
  ...
  if (loading) {
    return (
      <div className="bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-700 p-8 flex flex-col items-center gap-3 shadow-sm">
        ...
        <p className="text-sm text-zinc-500">K2-Think بيحلل سلوكك...</p>
      </div>
    )
  }
  ...
  return (
    <div className="bg-white dark:bg-zinc-800 rounded-2xl border border-zinc-200 dark:border-zinc-700 overflow-hidden shadow-sm">
      ...
      <div className="flex items-center justify-between px-5 py-3.5 border-b border-zinc-100 dark:border-zinc-700">
        <div>
          <h3 className="text-sm font-bold text-zinc-800 dark:text-zinc-100">تحليل السلوك</h3>
          <p className="text-xs text-zinc-400">آخر 30 يوم</p>
        </div>
      ...
      <div className="p-4 space-y-4">
        ...
        {!data.hasEnoughData ? (
          <div className="text-center py-4">
            <p className="text-sm text-zinc-500">محتاج بيانات أكتر — ابدأ تسجل تاسكاتك اليومية!</p>
          </div>
        ) : (
          <>
            {/* Insight tiles grid */}
            ...
            {data.studyStreak >= 2 && (
              <div className="flex items-center gap-2 px-4 py-2.5 rounded-xl bg-amber-50 dark:bg-amber-950/30 border border-amber-100 dark:border-amber-900">
                ...
                <p className="text-sm font-semibold text-amber-700 dark:text-amber-300">
                  {data.studyStreak} أيام متواصلة — استمر!
                </p>
              </div>
            )}
          </>
